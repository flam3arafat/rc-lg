...
## Requirements
- Any Linux distribution, this has been tested on RHEL 8 + 9, for NetBSD users see the project issue tracker and compatibility notes.
- PHP 8.0 or higher.
...
2. Clone this GitHub repository and configure the app for your RajshahiColo deployment.
...
7. Afterward, the RajshahiColo Looking Glass should be reachable from your web browser at `http://$your_server_ip/`!
