...
const LG_LOGO = '<img src="https://cp.rajshahicolo.com/assets/img/logo.png" alt="RajshahiColo" style="max-height: 42px; width: auto;">';
const LG_LOGO_DARK = '<img src="https://cp.rajshahicolo.com/assets/img/logo.png" alt="RajshahiColo" style="max-height: 42px; width: auto;">';

// Define the URL where the logo points to;
const LG_LOGO_URL = 'https://rajshahicolo.com/';
...
const LG_SPEEDTEST_FILES = [
    '100M' => 'https://proof.ovh.net/files/100Mb.dat',
    '1G' => 'https://proof.ovh.net/files/1Gb.dat',
    '10G' => 'https://proof.ovh.net/files/10Gb.dat'
];
